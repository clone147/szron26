...
const res = await fetch(AGENT_URL, {
  ...
  body: JSON.stringify({
    ...
    statusy: {
      ...
      kontakty: process.env.KONTAKTY_RESULT ?? null,
      kontakty_info: process.env.KONTAKTY_INFO ?? null,
      prospeo_credits: process.env.PROSPEO_CREDITS ? +process.env.PROSPEO_CREDITS : null,
    },
  }),
