...
- `.rv` (reveal-on-scroll) zneutralizowane w `ds/styles/components.css` — bez tego każdy element
  z klasą rv jest niewidoczny w renderach statycznych (site JS dodaje `.is-view`).
